        ...
        for row in train_raw:
            ...
            try:
                ...
                if type(row[5]) != float:
                    ...
                    # row[15] is cost - rescale by dividing by 1500
                    cost = row[15] / 1500. 
                ...
                continue
        #print([np.array(grade_category), np.array(subject_category), np.array(subject_subcategory), np.array(project_title), np.array(essay_1), np.array(essay_2), np.array(resource), np.array(proj_price)]
